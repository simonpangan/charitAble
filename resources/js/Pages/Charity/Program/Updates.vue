                    ...
                    <div class="box shadow-sm border rounded bg-white mb-3 osahan-post">
                        <div class="p-3 d-flex align-items-center border-bottom osahan-post-header">
                            <div class="dropdown-list-image me-3">
                                <img class="rounded-circle" v-bind:src="charity[0].logo"  alt="">
                            </div>
                            <div class="font-weight-bold">
                                <div class="text-truncate">{{charity[0].name}}<span class="text-info ms-1"><i data-bs-toggle="tooltip" data-bs-placement="top" title="Verified" class="feather-check-circle"></i></span></div>
