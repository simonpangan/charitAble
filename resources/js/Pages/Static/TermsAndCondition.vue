      ...
      <ul class="navbar-nav ms-auto d-flex align-items-center">
        ...
        <li class="nav-item dropdown me-2">
          ...
          <div class="dropdown-menu dropdown-menu-right shadow-sm">
            <a class="dropdown-item" href="jobs.html">
              <i class="feather-briefcase me-1"></i> Jobs </a>
            <a class="dropdown-item" href="profile.html">
              <i class="feather-user me-1"></i> Profile </a>
            <a class="dropdown-item" href="connection.html">
              <i class="feather-users me-1"></i> Connection </a>
            <a class="dropdown-item" href="company-profile.html">
              <i class="feather-user-plus me-1"></i> Company Profile </a>
            <a class="dropdown-item" href="job-profile.html">
              <i class="feather-globe me-1"></i> Job Profile </a>
            <a class="dropdown-item" href="messages.html">
              <i class="feather-message-circle me-1"></i> Messages </a>
            <a class="dropdown-item" href="notifications.html">
              <i class="feather-bell me-1"></i> Notifications </a>
            <a class="dropdown-item" href="not-found.html">
              <i class="feather-alert-triangle me-1"></i> 404 Not Found </a>
            <a class="dropdown-item" href="faq.html">
              <i class="feather-help-circle me-1"></i> FAQ </a>
            <a class="dropdown-item" href="terms.html">
              <i class="feather-book me-1"></i> Terms </a>
            <a class="dropdown-item" href="privacy.html">
              <i class="feather-list me-1"></i> Privacy </a>
            <a class="dropdown-item" href="blog.html">
              <i class="feather-book me-1"></i> Blog </a>
            <a class="dropdown-item" href="blog-single.html">
              <i class="feather-book-open me-1"></i> Blog Single </a>
            <a class="dropdown-item" href="contact.html">
              <i class="feather-mail me-1"></i> Contact </a>
            <a class="dropdown-item" href="pricing.html">
              <i class="feather-credit-card me-1"></i> Pricing </a>
            <a class="dropdown-item" href="maintence.html">
              <i class="feather-clock me-1"></i> Maintence </a>
            <a class="dropdown-item" href="coming-soon.html">
              <i class="feather-cloud me-1"></i> Coming Soon </a>
            <a class="dropdown-item" href="components.html">
              <i class="feather-list me-1"></i> Components </a>
            <a class="dropdown-item" href="sign-in.html">
              <i class="feather-log-in me-1"></i> Sign In </a>
            <a class="dropdown-item" href="sign-up.html">
              <i class="feather-lock me-1"></i> Sign Up </a>
          </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow ms-1 osahan-profile-dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right shadow-sm">
            ...
            <a class="dropdown-item" href="profile.html">
              <i class="feather-edit me-1"></i> My Account </a>
            <a class="dropdown-item" href="edit-profile.html">
              <i class="feather-user me-1"></i> Edit Profile </a>
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="sign-in.html">
