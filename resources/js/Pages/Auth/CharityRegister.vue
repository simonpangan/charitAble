            ...
            <div class="row">
              <div class="col">
                ...
                <div class="position-relative icon-form-control">
                  ...
                  <input
                    v-model.trim="form.charityEmail"
                    type="email"
                    class="form-control"
                  />
                ...
                <div class="wrapper">
                  <ul class="StepProgress">
                    <li class="StepProgress-item current">
                      ...
                      <p>Got more entries that you love? Buy more entries anytime!
                      Just hover on your favorite entry and click the Buy button</p>
                    </li>
        ...
        <div class="col-md-4">
          ...
          <div class="osahan-login py-4">
            ...
            <div class="row">
              <div class="col">
                ...
                <div class="position-relative icon-form-control">
                  <i class="feather-at-sign position-absolute"></i>
                  <input
                    v-model.trim="form.twitter_link"
                    type="email"
                    class="form-control"
                  />
                  <p class="text-danger" v-if="v$.charityEmail.$error">
            ...
            <div class="d-flex justify-content-end">
              <button
                class="btn btn-primary text-uppercase mt-5 mx-auto"
